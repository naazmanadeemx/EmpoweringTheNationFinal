...
class LandscapingActivity : AppCompatActivity() {
    ...
    private val courseFee = 1500 // Fee for the Landscaping course
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Find views
        val selectLandscapingCheckbox: CheckBox = findViewById(R.id.select_landscaping_course)
        ...
        selectLandscapingCheckbox.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                // Add the course to the selected courses
                SelectedCoursesManager.addCourse("Landscaping")
                Toast.makeText(this, "Landscaping course added to cart", Toast.LENGTH_SHORT).show()
            } else {
                // Remove the course from the selected courses
                SelectedCoursesManager.removeCourse("Landscaping")
                Toast.makeText(this, "Landscaping course removed from cart", Toast.LENGTH_SHORT).show()
            }
        }
