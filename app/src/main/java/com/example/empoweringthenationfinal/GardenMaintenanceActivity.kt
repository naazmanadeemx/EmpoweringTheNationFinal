...
class GardenMaintenanceActivity : AppCompatActivity() {
    ...
    private val courseFee = 750 // Fee for the Garden Maintenance course
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Find views
        val selectGardenMaintenanceCheckbox: CheckBox = findViewById(R.id.select_garden_maintenance_course)
        ...
        selectGardenMaintenanceCheckbox.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                // Add the course to the selected courses
                SelectedCoursesManager.addCourse("Garden Maintenance")
                ...
                SelectedCoursesManager.removeCourse("Garden Maintenance")
                Toast.makeText(this, "Garden Maintenance course removed from cart", Toast.LENGTH_SHORT).show()
            }
        }

        // Set an onClickListener on the calculate button
