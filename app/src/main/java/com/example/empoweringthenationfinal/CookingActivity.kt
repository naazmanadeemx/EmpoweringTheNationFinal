...
class CookingActivity : AppCompatActivity() {
    ...
    private val courseFee = 750 // Fee for the Cooking course
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Find views
        val selectCookingCheckbox: CheckBox = findViewById(R.id.select_cooking_course)
        ...
        selectCookingCheckbox.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                // Add the course to the selected courses
                SelectedCoursesManager.addCourse("Cooking")
                Toast.makeText(this, "Cooking course added to cart", Toast.LENGTH_SHORT).show()
            } else {
                // Remove the course from the selected courses
                SelectedCoursesManager.removeCourse("Cooking")
                Toast.makeText(this, "Cooking course removed from cart", Toast.LENGTH_SHORT).show()
            }
        }
