...
class LifeSkillsActivity : AppCompatActivity() {
    ...
    private val courseFee = 1500 // Fee for the Life Skills course
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Find views
        val selectLifeSkillsCheckbox: CheckBox = findViewById(R.id.select_life_skills_course)
        ...
        selectLifeSkillsCheckbox.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                // Add the course to the selected courses
                SelectedCoursesManager.addCourse("Life Skills")
                Toast.makeText(this, "Life Skills course added to cart", Toast.LENGTH_SHORT).show()
            } else {
                // Remove the course from the selected courses
                SelectedCoursesManager.removeCourse("Life Skills")
                Toast.makeText(this, "Life Skills course removed from cart", Toast.LENGTH_SHORT).show()
            }
        }
